...
export function Hero() {
  ...
  return (
    <section className="bg-secondary-5 py-20 lg:py-28 relative overflow-hidden">
          ...
          <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
            <motion.div
              ...
              <div>
                <Badge
                  variant="secondary"
                  className="badge mb-4 gradient-primary-secondary text-white px-4 py-2 rounded-md border-0">
              ...
              {/* <motion.div
                ...
                <Badge
                  variant="secondary"
                  className="mb-4 gradient-primary-secondary text-white border-0 px-4 py-2">
                  Your All-in-One Marketing Growth Partner
                </Badge>
              </motion.div> */}
              ...
              <h1 className="text-4xl tracking-tight sm:text-5xl md:text-6xl">
                ...
                {/* <motion.span
                  className="block gradient-primary-secondary bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent"
                  animate={{
                  ...
                  style={{ backgroundSize: "200% 200%", backgroundClip: "text" }}>
                  Real, Lasting Growth
                </motion.span> */}
                <span className="gradient-text">Real, Lasting Growth</span>
              </h1>
            </motion.div>
            ...
            <motion.div
              ...
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                We make marketing simple and effective for small businesses. No
                confusing jargon, no hidden costs — just practical,
                results-driven strategies that make growth straightforward and
                achievable.
              </p>
              ...
              <div className="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
                <div className="flex flex-col sm:flex-row gap-4">
                  <motion.div
                    ...
                    <Button
                      size="lg"
                      className="px-8 gradient-primary-secondary shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <motion.div
                    ...
                    <Button
                      variant="outline"
                      size="lg"
                      className="px-8 border-2 border-primary text-primary hover:bg-primary hover:text-white transition-all duration-300">
                      Learn More
                    </Button>
                  </motion.div>
                </div>
                ...
                <motion.p
                  ...
                  ✓ One client at a time for personalized attention
                  <br />
                  ✓ Transparent pricing with no hidden fees
                  <br />✓ Results-focused strategies that actually work
                </motion.p>
              </div>
            </motion.div>
          </div>
